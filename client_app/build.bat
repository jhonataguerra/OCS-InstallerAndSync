...
"%CSC_EXE%" /target:winexe /platform:anycpu /optimize+ /win32manifest:"%~dp0app.manifest.xml" /out:"%~dp0CadastroPatrimonio.exe" /r:System.dll,System.Windows.Forms.dll,System.Drawing.dll,System.Management.dll "%~dp0AppConfig.cs" "%~dp0RegistryHelper.cs" "%~dp0SystemInfoCollector.cs" "%~dp0MainForm.Designer.cs" "%~dp0MainForm.cs" "%~dp0Program.cs"
